...
const PROGRAM_ID = new PublicKey("2e1wdyNhUvE76y6yUCvah2KaviavMJYKoRun8acMRBZZ");
...
export function useChatStorageAccountKey() {
    ...
    return useAsync(async (wallet) => wallet
        ? (await getStorageAccount(new PublicKey(wallet), new BN(0)))[0]
        : undefined, [delegateWallet?.publicKey.toBase58()]);
}

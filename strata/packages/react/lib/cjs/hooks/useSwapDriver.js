...
const useSwapDriver = ({ onConnectWallet, id, tradingMints, onTradingMintsChange, swap, extraTransactionInfo, }) => {
    ...
    const { publicKey: owner } = (0, wallet_adapter_react_1.useWallet)();
    const base = baseMint && {
                ...
                yield swap(Object.assign(Object.assign({ baseMint: entangledBase, targetMint: entangledTarget }, outputAmountSetting), { slippage: +values.slippage / 100, ticker: target.ticker, preInstructions({ isFirst, amount, isBuy }) {
                    ...
                    postInstructions({ isLast, amount, isBuy }) {
                        return __awaiter(this, void 0, void 0, function* () {
                            ...
                            const instructions = [];
                            const signers = [];
                            let associatedAccountKey = yield spl_token_1.Token.getAssociatedTokenAddress(spl_token_1.ASSOCIATED_TOKEN_PROGRAM_ID, spl_token_1.TOKEN_PROGRAM_ID, entangledBase, owner);
                            if (isBuy) {
                                const { instructions: i1, signers: s1 } = yield (fungibleEntanglerSdk === null || fungibleEntanglerSdk === void 0 ? void 0 : fungibleEntanglerSdk.swapChildForParentInstructions({
                                    parentEntangler: parentEntangler.publicKey,
                                    childEntangler: childEntangler.publicKey,
                                    all: true,
                                }));
                                ...
                                signers.push(...s1);
                                associatedAccountKey = yield spl_token_1.Token.getAssociatedTokenAddress(spl_token_1.ASSOCIATED_TOKEN_PROGRAM_ID, spl_token_1.TOKEN_PROGRAM_ID, entangledTarget, owner);
                            }
                            instructions.push(spl_token_1.Token.createCloseAccountInstruction(spl_token_1.TOKEN_PROGRAM_ID, associatedAccountKey, owner, owner, []));
                            return {
                                instructions,
                                signers,
                                output: null,

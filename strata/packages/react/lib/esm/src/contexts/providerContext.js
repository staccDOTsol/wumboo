...
export const ProviderContextProvider = ({ children }) => {
    ...
    const provider = React.useMemo(() => {
        if (connection) {
            ...
            provider.sendAndConfirm = async function FixedSend(tx, signers, opts) {
    ...
    return (React.createElement(ProviderContext.Provider, { value: { awaitingApproval, provider } }, children));
};

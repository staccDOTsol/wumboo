...
export declare class SplTokenMetadata {
    ...
    static init(provider: AnchorProvider): Promise<SplTokenMetadata>;
    constructor(opts: {
        provider: AnchorProvider;
    });
    ...
    createMasterEditionInstructions({ mint, mintAuthority, payer, }: ICreateMasterEditionInstructionsArgs): Promise<InstructionResult<{
        metadata: PublicKey;
    }>>;
    createMasterEdition(args: ICreateMasterEditionInstructionsArgs): Promise<{
        metadata: PublicKey;
    }>;
    verifyCollectionInstructions({ nftMint, collectionMint, payer, }: IVerifyCollectionInstructionsArgs): Promise<InstructionResult<{
        metadata: PublicKey;
    }>>;
    verifyCollection(args: IVerifyCollectionInstructionsArgs): Promise<{
        metadata: PublicKey;
    }>;

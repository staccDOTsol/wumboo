...
exports.SplTokenMetadata = exports.getImageFromMeta = exports.MetadataCategory = void 0;
...
//@ts-ignore
const localStorage = (typeof global !== "undefined" && global.localStorage) || localstorage_memory_1.default;
class SplTokenMetadata {
    ...
    uploadMetadata(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const metadata = Object.assign({ name: args.name, symbol: args.symbol, description: args.description, 
                // @ts-ignore
                image: yield (0, shdw_1.uploadFiles)(this.provider, [args.image], undefined)[0], attributes: args.attributes, external_url: args.externalUrl || "", animation_rl: args.animationUrl, creators: args.creators ? args.creators : null, seller_fee_basis_points: 0 }, (args.extraMetadata || {}));
            const metadataFile = new File([JSON.stringify(metadata)], `${args.mint}-${randomId}.json`);
            // @ts-ignore
            const urls = yield (0, shdw_1.uploadFiles)(this.provider, [metadataFile, args.image], undefined);
            return urls[0];
        });
    }
    /**
    ...
    createMasterEditionInstructions({ mint, mintAuthority = this.provider.wallet.publicKey, payer = this.provider.wallet.publicKey, }) {
        return __awaiter(this, void 0, void 0, function* () {
            const metadataPubkey = yield mpl_token_metadata_1.Metadata.getPDA(mint);
            const masterEditionPubkey = yield mpl_token_metadata_1.MasterEdition.getPDA(mint);
            const instructions = new mpl_token_metadata_1.CreateMasterEditionV3({
                feePayer: payer,
            }, {
    ...
    createMasterEdition(args) {
        return __awaiter(this, void 0, void 0, function* () {
            const { instructions, signers, output } = yield this.createMasterEditionInstructions(args);
            yield this.sendInstructions(instructions, signers, args.payer);
            return output;
        });
    }
    verifyCollectionInstructions({ nftMint, collectionMint, payer = this.provider.wallet.publicKey, }) {
        return __awaiter(this, void 0, void 0, function* () {
            const metadataAccount = yield mpl_token_metadata_1.Metadata.getPDA(nftMint);
            const collectionMetadataAccount = yield mpl_token_metadata_1.Metadata.getPDA(collectionMint);
            const collectionMasterEdition = yield mpl_token_metadata_1.MasterEdition.getPDA(collectionMint);
            const instructions = new mpl_token_metadata_1.VerifyCollection({ feePayer: payer }, {
    ...
    verifyCollection(args) {
        return __awaiter(this, void 0, void 0, function* () {
            const { instructions, signers, output } = yield this.verifyCollectionInstructions(args);
            yield this.sendInstructions(instructions, signers, args.payer);
            return output;
        });
    }

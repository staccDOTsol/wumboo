...
export function Relink() {
  ...
  const walletSelect = (selecting: Selecting) => (
    <Button
      w="full"
      colorScheme="indigo"
      isLoading={!connected}
      ...
      {connected && (
        <>
          <FormControl>
            ...
            {newWallet && (
              <Input disabled={true} value={newWallet.toBase58()} />
            )}
            {walletSelect("new")}
          </FormControl>
          <FormControl>
            ...
            {prevWallet && (
              <Input value={prevWallet.toBase58()} disabled={true} />
            )}
            {walletSelect("prev")}
          </FormControl>
